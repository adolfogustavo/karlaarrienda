...
class Independientescaind extends CI_Controller {

    public function index()
    {
        $this->load->library('upload');
        $this->load->view('independientescaind.php');
    ...
    public function send()
    {
        ...
        {
            $message = '
            <h4><strong>Formulario:</strong> Trabajador independiente con aval misma condición</h4>
            <br>
            <h3 align="center">Datos del solicitante - Trabajador independiente</h3>
            ...
            <br>
            <h3 align="center">Datos del aval - Trabajador independiente</h3>
            <table border="1" width="100%" cellpadding="5">
            <td width="30%">Nombre</td>
            ...
            if($this->email->send()){
                ...
                redirect('index.php/independientescaind');
            }
            }
            else
            {
