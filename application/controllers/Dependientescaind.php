...
class Dependientescaind extends CI_Controller {

    public function index()
    {
        $this->load->library('upload');
        $this->load->view('dependientescaind.php');
    ...
    public function send()
    {
        ...
        {
            $message = '
            <h4><strong>Formulario:</strong> Trabajador dependiente con aval independiente</h4>
            <br>
            ...
            if($this->email->send()){
                ...
                redirect('index.php/dependientescaind');
            }
            }
            else
            {
