...
class Extcai extends CI_Controller {

    public function index()
    {
        $this->load->library('upload');
        $this->load->view('extcai.php');
    ...
    public function send()
    {
        ...
        {
            $message = '
            <h4><strong>Formulario:</strong>Extranjero con aval trabajador independiente</h4>
            <br>
