...
class Independientescad extends CI_Controller {

    public function index()
    {
        $this->load->library('upload');
        $this->load->view('independientescad.php');
    ...
    public function send()
    {
        ...
        {
            $message = '
            <h4><strong>Formulario:</strong> Trabajador independiente con aval dependiente</h4>
            <br>
            ...
            if($this->email->send()){
                ...
                redirect('index.php/independientescad');
            }
            }
            else
            {
