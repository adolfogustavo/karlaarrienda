...
<html>
	...
	<div class="main">
		...
		<form method="post" id="validate-form" action="<?php echo base_url(); ?>/index.php/dependientescad/send" enctype="multipart/form-data">
			<div class="container">
				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<div id="info-3" class="pt-1"></div>
							<!-- Segundo archivo -->
							<label for="file-upload-4" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-4" onchange='cambiar_4()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-4" class="pt-1"></div>
							<!-- Tercer archivo  -->
							<label for="file-upload-5" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-5" onchange='cambiar_5()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-5" class="pt-1"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-7" onchange='cambiar_7()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<div id="info-10" class="pt-1"></div>
							<!-- Segundo archivo -->
							<label for="file-upload-11" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-11" onchange='cambiar_11()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-11" class="pt-1"></div>
							<!-- Tercer archivo  -->
							<label for="file-upload-12" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-12" onchange='cambiar_12()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-12" class="pt-1"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
							<div class="subtitle pb-2">Dicom Platinum 360<span class="obligatorio">*</span></span></div>
							<label for="file-upload-13" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-13" onchange='cambiar_13()' type="file" style='display: none;' name="userfile[]" accept=".pdf" required/>
							<div id="info-13" class="pt-3"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
							<div class="subtitle pb-2">Contrato de trabajo o Certificado de antigüedad laboral<span class="obligatorio">*</span></div>
							<label for="file-upload-14" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-14" onchange='cambiar_14()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-14" class="pt-3"></div>
						</div>
					</div>
					<hr>
				</div>
			<div class="container">
				...
				<div class="row">
					<div class="form-group col-12 text-center">
                              <button type="submit" name="submit" class="btn btn-secondary btn-send">Enviar solicitud </button>
                         </div>
				</div>
			</div>
		</form>
	...
	<script src="<?php echo base_url(); ?>assets/js/inputchange-dependientescad.js"></script>
	</body>
</html>