...
<html>
	...
	<div class="main">
		...
		<form method="post" id="validate-form" action="<?php echo base_url(); ?>index.php/dependientescad/send" enctype="multipart/form-data">
				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-4" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-1"></div>
							<!-- Tercer archivo  -->
							<label for="file-upload-5" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-5" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-1"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-7" class="file-upload-required" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-3"></div>
						</div>
					</div>
					<hr>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-10" class="file-upload-required" type="file" style='display: none;' name="userfile[]" accept=".pdf" required/>
							<div class="info pt-1"></div>
							<!-- Segundo archivo -->
							...
							<input id="file-upload-12" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-1"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
							<div class="subtitle pb-2">Dicom Platinum 360<span class="obligatorio">*</span></span></div>
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-14" class="file-upload-required" type="file" style='display: none;' name="userfile[]" accept=".pdf" required/>
							<div class="info pt-3"></div>
						</div>
					</div>
					<hr>
            ...
            <button type="submit" class="btn btn-secondary btn-send" id="btn-send">Enviar solicitud </button>
          </div>
				</div>
			</div>
		</form>
