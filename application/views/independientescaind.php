...
<html>
     <head>
          <title>Aplicación para arrendar propiedad - Trabajador independiente con aval independiente</title>
	...
	<div class="main">
		...
		<form method="post" id="validate-form" action="<?php echo base_url(); ?>/index.php/independientescaind/send" enctype="multipart/form-data">
			<div class="container">
	...
	<script src="<?php echo base_url(); ?>assets/js/inputchange-independientescaind.js"></script>
	</body>
</html>