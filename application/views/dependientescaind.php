...
<html>
     <head>
          <title>Aplicación para arrendar propiedad - Trabajador dependiente con aval independiente</title>
	...
	<div class="main">
		...
		<form method="post" id="validate-form" action="<?php echo base_url(); ?>/index.php/dependientescaind/send" enctype="multipart/form-data">
			<div class="container">
				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-12" onchange='cambiar_12()' type="file" style='display: none;' name="userfile[]" accept=".pdf" required/>
							<div id="info-12" class="pt-3"></div>
                              </div>
                              <div class="col-lg-4 col-md-6 col-12 text-center">
	...
	<script src="<?php echo base_url(); ?>assets/js/inputchange-dependientescaind.js"></script>
	</body>
</html>