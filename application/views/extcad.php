...
<html>
     <head>
          <title>Aplicación para arrendar propiedad - Extranjero con aval trabajador dependiente</title>
	...
	<div class="main">
		...
		<form method="post" id="validate-form" action="<?php echo base_url(); ?>/index.php/extcad/send" enctype="multipart/form-data">
			<div class="container">
				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<div id="info-8" class="pt-1"></div>
							<!-- Segundo archivo -->
							<label for="file-upload-9" class="subir"><i class="fas fa-cloud-upload-alt"></i> Seleccione PDF</label>
							<input id="file-upload-9" onchange='cambiar_9()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div id="info-9" class="pt-1"></div>
							<!-- Tercer archivo  -->
	...
	<script src="<?php echo base_url(); ?>assets/js/inputchange-extcad.js"></script>
	</body>
</html>