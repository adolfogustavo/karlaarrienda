				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-3" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-3"></div>
						</div>
						<div class="col-lg-4 col-md-6 col-12 text-center">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-5" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf" required/>
							<div class="info pt-3"></div>
						</div>
					</div>
					<hr>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-9" class="file-upload-optional" type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
							<div class="info pt-1"></div>
							<!-- Tercer archivo  -->
