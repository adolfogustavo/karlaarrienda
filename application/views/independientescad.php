...
<html>
				...
				<div class="row-karla">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-12 text-center">
							...
							<input id="file-upload-13" onchange='cambiar_13()' type="file" style='display: none;' name="userfile[]" accept=".pdf"/>
	...
	<script src="<?php echo base_url(); ?>assets/js/inputchange-independientescad.js"></script>
	</body>
</html>